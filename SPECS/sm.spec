...
# git format-patch v2.30.8-7-xcpng..2.30.8-8.2
# Note: the v2.30.8-7-xcpng tag was manually created by us on our fork because
...
# After that we can create the tag: `git tag -a v2.30.8-7-xcpng -m "v2.30.8-7-xcpng"`,
