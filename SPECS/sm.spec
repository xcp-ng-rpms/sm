...
# git format-patch v3.0.3-xcpng..3.0.3-8.3
# Note: the v3.0.3-xcpng tag was manually created by us on our fork because
# the upstream sm doesn't provide maintenance updates anymore
# To create this tag in the sources, you must create a 3.0.3-8.3 branch from the
...
# After that we can create the tag: `git tag -a v3.0.3-xcpng -m "v3.0.3-xcpng"`,
...
%changelog
* Mon Mar 06 2023 Ronan Abhamon <ronan.abhamon@vates.fr> - 3.0.3-1.1
